...
const SalesDashboard = lazy(() => import('./pages/dashboard/SalesDashboard.jsx').then(m => ({ default: m.SalesDashboard })));
const UsersPage = lazy(() => import('./pages/settings/TeamManagement.jsx'));
